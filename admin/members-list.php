...
?>
                ...
                <div class="list-header">
                    <h1 class="page-title"><i class="fas fa-users" style="margin-right: 10px;"></i>Manage Members</h1>
                    <a href="add-member.php" class="add-btn">
                ...
                <form method="GET" class="filters-container">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="members-list.php" class="reset-filter">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <strong><?php echo htmlspecialchars($member['first_name'] . ' ' . $member['mothers_name']); ?></strong>
                                            </td>
