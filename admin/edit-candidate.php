...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Check for duplicate phone (excluding current candidate)
...
.current-photo img { max-width: 150px; max-height: 150px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,.1); cursor: zoom-in; }
...
<div class="form-container-admin">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="current-photo">
                                            ...
                                            <a href="<?php echo htmlspecialchars($photo_url); ?>" class="open-photo">
                                                <img src="<?php echo htmlspecialchars($photo_url); ?>" alt="Member Photo" style="cursor:zoom-in; max-width:150px; max-height:150px; border-radius:8px;">
                                            </a>
                                            <div style="margin-top:6px;">
                                                <a href="<?php echo htmlspecialchars($photo_url); ?>" download class="btn btn-secondary" style="padding:6px 10px; font-size:13px; text-decoration:none; display:inline-block;">Download</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="form-buttons">
            ...
            <a href="candidates-list.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i>Back to List</a>
        </div>
    </form>
</div>
