               ...
               <div class="stats-grid">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    ...
                    <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
                        ...
                        <div style="font-size: 14px; color: #666;">
                            <p style="margin-bottom: 8px;"><strong>Avg Members/Month:</strong> <?php echo ceil($members_count / 12); ?></p>
                            <p style="margin-bottom: 8px;"><strong>Approval Rate:</strong> <?php echo $members_count > 0 ? round(($approved_count / $members_count) * 100, 1) : 0; ?>%</p>
                            <p style="margin-bottom: 8px;"><strong>Pending Rate:</strong> <?php echo $members_count > 0 ? round(($pending_count / $members_count) * 100, 1) : 0; ?>%</p>
                        </div>
                    </div>
                </div>
