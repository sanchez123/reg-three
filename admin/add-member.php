                        ...
                        <div class="form-row full">
                            <div class="form-group">
                                ...
                                <div class="security-wrapper">
                                    <div class="security-number"><?php echo $_SESSION['security_code']; ?></div>
                                    <input type="text" name="security_code" placeholder="Enter the security code" required value="<?php echo htmlspecialchars($form_data['security_code'] ?? ''); ?>">
                                </div>
                            </div>
                        </div>
